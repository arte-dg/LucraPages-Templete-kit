<?php
/**
 * Plugin Name: LucraPage$ Kit Import
 * Description: Plugin extra para importar com mais facilidade os modelos do LucraPage$
 * Author: SUPORTE
 * Author URI: https://escolaelementor.com
 * Version: 1.0.11
